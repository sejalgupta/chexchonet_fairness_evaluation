...
Run5_sex = pd.read_csv("./results/results42/Run5_TPR_sex.csv")
Run4_sex = pd.read_csv("./results/results35/Run4_TPR_sex.csv")
Run3_sex = pd.read_csv("./results/results25/Run3_TPR_sex.csv")
Run2_sex = pd.read_csv("./results/results21/Run2_TPR_sex.csv")
Run1_sex = pd.read_csv("./results/results9/Run1_TPR_sex.csv")
...
Want = pd.DataFrame(pd.DataFrame(diseases, columns=["Category"]))
PrcentM_list = []
CIM_list = []
Gap_M_mean_list = []
Distance_list = []
...
d = {'diseases': diseases, 'Distance': Distance_list,
...
plt.scatter(WantX['diseases'],WantX['Gap_M_mean'],s= np.multiply(WantX['%M'],500), marker='o',color='blue', label="Male")
plt.errorbar(WantX['diseases'],WantX['Gap_M_mean'],yerr = WantX['CI_M'],fmt='o',mfc='blue')
plt.scatter(WantX['diseases'],WantX['Gap_F_mean'],s= np.multiply(WantX['%F'],500), marker='o',color='red', label="Female")
plt.errorbar(WantX['diseases'],WantX['Gap_F_mean'],yerr = WantX['CI_F'],fmt='o',mfc='red')

plt.xticks(rotation = deg)
plt.ylabel("TPR SEX DISPARITY")
plt.legend()
plt.grid(True)
plt.savefig("./results/SEX_TPRDis_CXP.pdf")

#---------------------------------------------------   Age

Run5_Age = pd.read_csv("./results/results42/Run5_TPR_age_decile.csv")
Run4_Age = pd.read_csv("./results/results35/Run4_TPR_age_decile.csv")
Run3_Age = pd.read_csv("./results/results25/Run3_TPR_age_decile.csv")
Run2_Age = pd.read_csv("./results/results21/Run2_TPR_age_decile.csv")
Run1_Age = pd.read_csv("./results/results9/Run1_TPR_age_decile.csv")
...
df40 = resAge_df['%60-80']['mean']
df41 = resAge_df['Gap_60-80']["mean"]
df42 = 1.96*resAge_df['Gap_60-80']["std"]/np.sqrt(Number)

df60 = resAge_df['%40-60']['mean']
df61 = resAge_df['Gap_40-60']["mean"]
df62 = 1.96*resAge_df['Gap_40-60']["std"]/np.sqrt(Number)
...
plt.figure(figsize=(16,m))
plt.scatter(WantAge['diseases'],WantAge['Gap_60-80_mean'],s= np.multiply(WantAge['%60-80'],500), marker='o',color='blue', label="60-80")
plt.errorbar(WantAge['diseases'],WantAge['Gap_60-80_mean'],yerr = WantAge['CI_60-80'],fmt='o',mfc='blue')
plt.scatter(WantAge['diseases'],WantAge['Gap_40-60_mean'],s= np.multiply(WantAge['%40-60'],500), marker='o',color='orange', label="40-60")
plt.errorbar(WantAge['diseases'],WantAge['Gap_40-60_mean'],yerr = WantAge['CI_40-60'],fmt='o',mfc='orange')
plt.scatter(WantAge['diseases'],WantAge['Gap_20-40_mean'],s= np.multiply(WantAge['%20-40'],500), marker='o',color='green', label="20-40")
plt.errorbar(WantAge['diseases'],WantAge['Gap_20-40_mean'],yerr = WantAge['CI_20-40'],fmt='o',mfc='green')
plt.scatter(WantAge['diseases'],WantAge['Gap_80-_mean'],s= np.multiply(WantAge['%80-'],500), marker='o',color='red', label="80-")
plt.errorbar(WantAge['diseases'],WantAge['Gap_80-_mean'],yerr = WantAge['CI_80-'],fmt='o',mfc='red')
plt.scatter(WantAge['diseases'],WantAge['Gap_0-20_mean'],s= np.multiply(WantAge['%0-20'],500), marker='o',color='purple', label="0-20")
plt.errorbar(WantAge['diseases'],WantAge['Gap_0-20_mean'],yerr = WantAge['CI_0-20'],fmt='o',mfc='purple')

plt.xticks(rotation = deg)
plt.ylabel("TPR AGE DISPARITY")
plt.legend()
plt.grid(True)
plt.savefig("./results/AGE_TPRDisp_ALL.pdf")